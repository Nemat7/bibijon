...
const BASE = '/pdfs/oborudovaniye/princecastle-toster/'

const videos = [
  { embed: 'https://www.youtube.com/embed/RtNYMAs2W78', url: 'https://www.youtube.com/watch?v=RtNYMAs2W78', label: 'Видео 1' },
  { embed: 'https://www.youtube.com/embed/VJ6CiSpk3Kc', url: 'https://www.youtube.com/watch?v=VJ6CiSpk3Kc', label: 'Видео 2' },
  { embed: 'https://www.youtube.com/embed/Yptq-u0IbB8', url: 'https://www.youtube.com/watch?v=Yptq-u0IbB8', label: 'Видео 3' },
  { embed: 'https://www.youtube.com/embed/3vzvBrA-OGE', url: 'https://www.youtube.com/watch?v=3vzvBrA-OGE', label: 'Видео 4' },
]

const fileNames: string[] = [
  'Вертикальный тостер PRINCECASTLE.pdf',
  'Prince Castle 297-T.pdf',
]
...
export default function PrincecastleTosterPage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
        breadcrumbItems={[
          ...
          { label: 'Вертикальный тостер PRINCECASTLE' },
        ]}
      />
      <div className="px-4 pt-5 pb-12 sm:px-8 sm:pt-7">
        ...
        >
          Вертикальный тостер PRINCECASTLE
        </h1>
          ...
          {videos.map((video) => (
            <div key={video.embed}>
              ...
              >
                <iframe
                  src={video.embed}
                  title={`Вертикальный тостер PRINCECASTLE — ${video.label}`}
