...
const BASE = '/pdfs/oborudovaniye/gril-star/'

const videos = [
  { embed: 'https://www.youtube.com/embed/isrbEVxtdsE', url: 'https://www.youtube.com/watch?v=isrbEVxtdsE', label: 'Видео 1' },
  { embed: 'https://www.youtube.com/embed/aMHtN7_5eC0', url: 'https://www.youtube.com/watch?v=aMHtN7_5eC0', label: 'Видео 2' },
  { embed: 'https://www.youtube.com/embed/zhYDCkRheOY', url: 'https://www.youtube.com/watch?v=zhYDCkRheOY', label: 'Видео 3' },
  { embed: 'https://www.youtube.com/embed/JJTh8aBKf74', url: 'https://www.youtube.com/watch?v=JJTh8aBKf74', label: 'Видео 4' },
  { embed: 'https://www.youtube.com/embed/UYLo7F5603A', url: 'https://www.youtube.com/watch?v=UYLo7F5603A', label: 'Видео 5' },
]

const fileNames: string[] = [
  'Гриль STAR.pdf',
  'Гриль STAR GR14SPTK.pdf',
]
...
export default function GrilStarPage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
