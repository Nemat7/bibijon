...
const BASE = '/pdfs/oborudovaniye/follett-lar/'

const VIDEO_URL = 'https://www.youtube.com/watch?v=IjWVzUiK6hI'
const VIDEO_EMBED = 'https://www.youtube.com/embed/IjWVzUiK6hI'

const fileNames: string[] = [
  'Ларь морозильный FOLLETT.pdf',
  'Морозильный ларь Follett ZF120-180.pdf',
]
...
export default function FollettLarPage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
        breadcrumbItems={[
          ...
          { label: 'Ларь морозильный FOLLETT' },
        ]}
      />
      <div className="px-4 pt-5 pb-12 sm:px-8 sm:pt-7">
        ...
        <div style={{ maxWidth: '780px', marginBottom: '28px' }}>
          ...
          >
            <iframe
              src={VIDEO_EMBED}
              title="Ларь морозильный FOLLETT"
