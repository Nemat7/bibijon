...
const BASE = '/pdfs/oborudovaniye/polair/'

const fileNames: string[] = [
  'Шкаф холодильный Polair CM-107G.pdf',
  'Холодильный шкаф Polair CM-107G.pdf',
]
...
export default function PolairPage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
        breadcrumbItems={[
          ...
          { label: 'Шкаф холодильный Polair CM-107G' },
        ]}
      />
      <div className="px-4 pt-5 pb-12 sm:px-8 sm:pt-7">
        ...
        >
          Шкаф холодильный Polair CM-107G
        </h1>
