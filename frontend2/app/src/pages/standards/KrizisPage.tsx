...
const BASE = '/pdfs/upravleniye/krizis/'

const fileNames: string[] = [
  'Кризис Менеджмент.pdf',
  'Корпоративное поведение_СМИ и соцсети.pdf',
  'Памятки по действиям в нестандартных ситуациях.pdf',
]
...
export default function KrizisPage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
