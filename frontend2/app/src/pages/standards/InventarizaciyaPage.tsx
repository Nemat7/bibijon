...
const BASE = '/pdfs/upravleniye/inventarizaciya/'

const fileNames: string[] = [
  'Инвентаризация.pdf',
  'Инструкция закрытия периода в Crunch Time для корпоративных ресторанов 11.03. 2021.pdf',
  'Инструкция - Контроль товарных остатков в корпоративных ресторанов 01.01.21.doc',
]
