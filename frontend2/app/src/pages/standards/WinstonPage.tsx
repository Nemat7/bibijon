...
const BASE = '/pdfs/oborudovaniye/winston/'

const VIDEO_URL = 'https://www.youtube.com/watch?v=kMtdEf8yKA8'
const VIDEO_EMBED = 'https://www.youtube.com/embed/kMtdEf8yKA8'

const fileNames: string[] = ['Жаровня Winston.pdf']
