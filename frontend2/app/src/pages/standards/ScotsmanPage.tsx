...
const BASE = '/pdfs/oborudovaniye/scotsman/'

const VIDEO_URL = 'https://www.youtube.com/watch?v=Rwttx1vhJT0'
const VIDEO_EMBED = 'https://www.youtube.com/embed/Rwttx1vhJT0'

const fileNames: string[] = ['Льдогенератор SCOTSMAN.pdf']

function getDisplayName(name: string) {
  return name.replace(/\.[^.]+$/, '')
}

export default function ScotsmanPage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
