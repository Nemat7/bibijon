...
const BASE = '/pdfs/oborudovaniye/marmit/'

const videos = [
  { src: BASE + 'Мармит BM1W видео 1.mov', label: 'Мармит BM1W — Видео 1' },
  { src: BASE + 'Мармит BM1W видео 2.mov', label: 'Мармит BM1W — Видео 2' },
]

const fileNames = ['Мармит BM1W (BM).pdf']

function getDisplayName(name: string) {
  return name.replace(/\.[^.]+$/, '')
}

export default function MarmitPage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
