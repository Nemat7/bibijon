...
const BASE = '/pdfs/oborudovaniye/ttm/'

const VIDEO_URL = 'https://www.youtube.com/watch?v=mpMeh07-pIE'
const VIDEO_EMBED = 'https://www.youtube.com/embed/mpMeh07-pIE'

const fileNames: string[] = [
  'Тепловая витрина ТТМ.pdf',
  'БУРГЕРШУТ ТТМ KFVT2-620.pdf',
]
