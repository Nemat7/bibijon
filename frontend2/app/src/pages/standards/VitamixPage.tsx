...
const BASE = '/pdfs/oborudovaniye/vitamix/'

const videos = [
  { src: BASE + 'Миксер Vita Mix видео 1.mov', label: 'Миксер Vita Mix — Видео 1' },
  { src: BASE + 'Миксер Vita Mix видео 2.mov', label: 'Миксер Vita Mix — Видео 2' },
  { src: BASE + 'Миксер Vita Mix видео 3.mov', label: 'Миксер Vita Mix — Видео 3' },
]
...
export default function VitamixPage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
      ...
      <div className="px-4 pt-5 pb-12 sm:px-8 sm:pt-7">
        ...
        <div className="flex flex-col gap-6" style={{ maxWidth: '780px', marginBottom: '28px' }}>
          {videos.map((video) => (
            <div key={video.src}>
              <p className="text-[#212121] font-semibold" style={{ fontSize: '14px', marginBottom: '10px' }}>
                {video.label}
              </p>
              <div
                style={{
              ...
              >
                <video
                  controls
                  style={{ width: '100%', display: 'block', maxHeight: '440px' }}
                >
