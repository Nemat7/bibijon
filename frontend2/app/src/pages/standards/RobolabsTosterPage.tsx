...
const BASE = '/pdfs/oborudovaniye/robolabs-toster/'

const videos = [
  { embed: 'https://www.youtube.com/embed/7IG9NA1Wbt0', url: 'https://www.youtube.com/watch?v=7IG9NA1Wbt0', label: 'Видео 1' },
  { embed: 'https://www.youtube.com/embed/LSw8IYvj1CU', url: 'https://www.youtube.com/watch?v=LSw8IYvj1CU', label: 'Видео 2' },
]

const fileNames: string[] = [
  'Вертикальный тостер ROBOLABS.pdf',
  'Тостер вертикальный ROBOLABS.pdf',
]
...
export default function RobolabsTosterPage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
        breadcrumbItems={[
          ...
          { label: 'Вертикальный тостер ROBOLABS' },
        ]}
      />
          ...
          {videos.map((video) => (
            <div key={video.embed}>
              ...
              >
                <iframe
                  src={video.embed}
                  title={`Вертикальный тостер ROBOLABS — ${video.label}`}
