...
const BASE = '/pdfs/oborudovaniye/icematic/'

const VIDEO_URL = 'https://www.youtube.com/watch?v=yQy6fLsHR0U'
const VIDEO_EMBED = 'https://www.youtube.com/embed/yQy6fLsHR0U'

const fileNames: string[] = ['Льдогенератор ICEMATIC.pdf']

function getDisplayName(name: string) {
  return name.replace(/\.[^.]+$/, '')
}

export default function IcematicPage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
