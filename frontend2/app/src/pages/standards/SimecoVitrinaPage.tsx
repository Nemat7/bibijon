...
const BASE = '/pdfs/oborudovaniye/simeco-vitrina/'

const fileNames: string[] = [
  'Тепловая витрина Simeco.pdf',
  'Витрина тепловая Simeco.pdf',
]
...
export default function SimecoVitrinaPage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
