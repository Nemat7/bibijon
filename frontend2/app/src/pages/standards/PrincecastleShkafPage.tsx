...
const BASE = '/pdfs/oborudovaniye/princecastle-shkaf/'

const VIDEO_URL = 'https://www.youtube.com/watch?v=TUHNE4YB3SA'
const VIDEO_EMBED = 'https://www.youtube.com/embed/TUHNE4YB3SA'

const fileNames: string[] = [
  'Тепловой шкаф Prince Castle.pdf',
  'Инструкция PrinceCastle DHB.pdf',
]
...
export default function PrincecastleShkafPage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
        breadcrumbItems={[
          ...
          { label: 'Тепловой шкаф Prince Castle' },
        ]}
      />
      <div className="px-4 pt-5 pb-12 sm:px-8 sm:pt-7">
        ...
        <div style={{ maxWidth: '780px', marginBottom: '28px' }}>
          ...
          >
            <iframe
              src={VIDEO_EMBED}
              title="Тепловой шкаф Prince Castle"
