...
const BASE = '/pdfs/oborudovaniye/princecastle-gril/'

const fileNames: string[] = [
  'Гриль PRINCE CASTLE.pdf',
  'Гриль Prince Castle CG14D.pdf',
]
...
export default function PrincecastleGrilPage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
