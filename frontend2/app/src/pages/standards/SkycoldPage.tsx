...
const BASE = '/pdfs/oborudovaniye/skycold/'

const fileNames: string[] = [
  'Холодильник-морозильник SKYCOLD GNH-GNL.pdf',
  'Холодильный стол SKYCOLD.pdf',
]
...
export default function SkycoldPage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
        breadcrumbItems={[
          ...
          { label: 'Холодильник/морозильник SKYCOLD GNH/GNL' },
        ]}
      />
      <div className="px-4 pt-5 pb-12 sm:px-8 sm:pt-7">
        ...
        >
          Холодильник/морозильник SKYCOLD GNH/GNL
        </h1>
