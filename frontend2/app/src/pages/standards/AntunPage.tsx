...
const BASE = '/pdfs/oborudovaniye/antunes/'

const fileNames = ['Antunes RoundUp ES1200.pdf']

function getDisplayName(name: string) {
  return name.replace(/\.[^.]+$/, '')
}

export default function AntunесPage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
      ...
      <div className="px-4 pt-5 pb-12 sm:px-8 sm:pt-7">
        ...
        <div style={{ maxWidth: '780px', marginBottom: '28px' }}>
          ...
          >
            ...
            >
              <source src={BASE + 'Antunes ES-1200 видео.mov'} type="video/quicktime" />
              <source src={BASE + 'Antunes ES-1200 видео.mov'} type="video/mp4" />
