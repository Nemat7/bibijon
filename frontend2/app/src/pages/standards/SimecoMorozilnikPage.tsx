...
const BASE = '/pdfs/oborudovaniye/simeco-morozilnik/'

const fileNames: string[] = [
  'Морозильник SIMECO.pdf',
  'Стол морозильный c бортом 1 дверь Simeco.pdf',
  'Стол морозильный без борта 1 дверь Simeco.pdf',
]
...
export default function SimecoMorozilnikPage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
