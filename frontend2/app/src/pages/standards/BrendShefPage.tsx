...
const BASE = '/pdfs/upravleniye/brend-shef/'

const fileNames: string[] = [
  'Бренд Шеф KFC.pdf',
  'Ежедневная рутина Бренд Шефа.pdf',
  'Интересные факты для проведение дегустаций.pdf',
]
...
export default function BrendShefPage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
