...
const BASE = '/pdfs/oborudovaniye/ayrking/'

const fileNames: string[] = [
  'Стол панировочный AYRKING.pdf',
  'Панировочный стол Ayrking BBS-EC.pdf',
]
...
const videos = [
  {
    embed: 'https://www.youtube.com/embed/rD74WIflKAY',
    url: 'https://www.youtube.com/watch?v=rD74WIflKAY',
    label: 'Видео 1',
  },
  {
    embed: 'https://www.youtube.com/embed/PANsLDsJgIA',
    url: 'https://www.youtube.com/watch?v=PANsLDsJgIA',
    label: 'Видео 2',
  },
]

export default function AyrkingPage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
        breadcrumbItems={[
          ...
          { label: 'Стол панировочный AYRKING' },
        ]}
      />
