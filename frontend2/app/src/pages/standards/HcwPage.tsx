...
const BASE = '/pdfs/oborudovaniye/hcw/'

const fileNames: string[] = [
  'Тепловая витрина HCW.pdf',
  'Тепловая витрина HCW-5.pdf',
]
...
export default function HcwPage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
