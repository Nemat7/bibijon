...
const BASE = '/pdfs/oborudovaniye/franke/'

const fileNames: string[] = [
  'Устройство дозирования полуфабриката замороженного картофеля Franke модель F3D3P.pdf',
  'Устройство для дозирования картофеля Franke.pdf',
]
...
export default function FrankePage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
        breadcrumbItems={[
          ...
          { label: 'Устройство дозирования Franke F3D3P' },
        ]}
      />
      <div className="px-4 pt-5 pb-12 sm:px-8 sm:pt-7">
        ...
        >
          Устройство дозирования полуфабриката замороженного картофеля Franke модель F3D3P
        </h1>
