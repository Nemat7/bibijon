...
const BASE = '/pdfs/oborudovaniye/orwak/'

const VIDEO_URL = 'https://www.youtube.com/watch?v=X8MvrIxlhuw'
const VIDEO_EMBED = 'https://www.youtube.com/embed/X8MvrIxlhuw'

const fileNames: string[] = [
  'Пресс для мусора ORWAK.pdf',
  'Пресс для мусора OM_5030_CE.pdf',
]
...
export default function OrwakPage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
