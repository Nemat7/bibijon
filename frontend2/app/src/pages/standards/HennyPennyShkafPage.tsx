...
const BASE = '/pdfs/oborudovaniye/henny-penny-shkaf/'

const fileNames: string[] = [
  'Тепловой шкаф Henny Penny.pdf',
  'Тепловой шкаф HеnnyPenny 136.pdf',
]

const VIDEO_URL = 'https://www.youtube.com/watch?v=dCHd1gFKbsQ'
const VIDEO_EMBED = 'https://www.youtube.com/embed/dCHd1gFKbsQ'

function getDisplayName(name: string) {
  return name.replace(/\.[^.]+$/, '')
}

export default function HennyPennyShkafPage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
