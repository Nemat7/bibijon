...
const BASE = '/pdfs/oborudovaniye/testo-saveris/'

const VIDEO_URL = 'https://www.youtube.com/watch?v=Fjh9g8Uz2kM'
const VIDEO_EMBED = 'https://www.youtube.com/embed/Fjh9g8Uz2kM'

const fileNames: string[] = ['Testo Saveris 0560 model 1020.pdf']

function getDisplayName(name: string) {
  return name.replace(/\.[^.]+$/, '')
}

export default function TestoSaverisPage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
        breadcrumbItems={[
          ...
          { label: 'Testo Saveris 0560 модель 1020' },
        ]}
      />
      <div className="px-4 pt-5 pb-12 sm:px-8 sm:pt-7">
        ...
        >
          Testo Saveris 0560 модель 1020
        </h1>
        ...
        <div style={{ maxWidth: '780px', marginBottom: '28px' }}>
          ...
          >
            <iframe
              src={VIDEO_EMBED}
              title="Testo Saveris 0560 модель 1020"
