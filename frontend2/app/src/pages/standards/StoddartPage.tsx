...
const BASE = '/pdfs/oborudovaniye/stoddart/'

const fileNames: string[] = [
  'Сэндвичная станция Stoddart.pdf',
  'Sendvichnaya stanciya Stoddart.pdf',
]
...
export default function StoddartPage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
        breadcrumbItems={[
          ...
          { label: 'Сэндвичная станция Stoddart' },
        ]}
      />
