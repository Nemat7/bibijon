...
const BASE = '/pdfs/oborudovaniye/simeco-othody/'

const fileNames: string[] = [
  'ХОЛОДИЛЬНИК ДЛЯ ОТХОДОВ SIMECO.pdf',
  'Стол холодильный для сбора отходов SIMECO.pdf',
]
...
export default function SimecoOthodPage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
        breadcrumbItems={[
          ...
          { label: 'ХОЛОДИЛЬНИК ДЛЯ ОТХОДОВ SIMECO' },
        ]}
      />
      <div className="px-4 pt-5 pb-12 sm:px-8 sm:pt-7">
        ...
        >
          ХОЛОДИЛЬНИК ДЛЯ ОТХОДОВ SIMECO
        </h1>
        ...
        <div style={{ maxWidth: '780px', marginBottom: '28px' }}>
          ...
          >
            <iframe
              src={VIDEO_EMBED}
              title="ХОЛОДИЛЬНИК ДЛЯ ОТХОДОВ SIMECO"
