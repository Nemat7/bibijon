...
const BASE = '/pdfs/upravleniye/rgs/'

const fileNames: string[] = [
  'RGS Running Great Shifts.pdf',
  'Руководство RGS 3.0_0.pdf',
  'Бланк сертификации Ведения смены RGS 3.0.pdf',
  'RGS 3.0_ver 3.xlsx',
]
    ...
    <div>
      <Topbar
        ...
        breadcrumbItems={[
          ...
          { label: 'RGS (Running Great Shifts)' },
        ]}
      />
