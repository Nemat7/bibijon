...
const BASE = '/pdfs/oborudovaniye/hatco/'

const fileNames: string[] = [
  'Фасовочная станция Hatco.pdf',
  'Фасовочная станция Hatco GRFHS.pdf',
]
...
export default function HatcoPage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
        breadcrumbItems={[
          ...
          { label: 'Фасовочная станция Hatco' },
        ]}
      />
