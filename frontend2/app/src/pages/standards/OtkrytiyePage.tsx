...
const BASE = '/pdfs/upravleniye/otkrytiye/'

const fileNames: string[] = [
  'Руководство по открытию новых ресторанов.pdf',
  'KFC Руководство по открытию ресторанов_0.pdf',
]
...
export default function OtkrytiyePage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
        breadcrumbItems={[
          ...
          { label: 'Руководство по открытию новых ресторанов' },
        ]}
      />
      <div className="px-4 pt-5 pb-12 sm:px-8 sm:pt-7">
        ...
        >
          Руководство по открытию новых ресторанов
        </h1>
