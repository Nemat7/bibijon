...
const BASE = '/pdfs/oborudovaniye/frymaster-re14/'

const videos = [
  { embed: 'https://www.youtube.com/embed/yrCydxIcs_U', url: 'https://www.youtube.com/watch?v=yrCydxIcs_U', label: 'Видео 1' },
  { embed: 'https://www.youtube.com/embed/td1_fR43gcg', url: 'https://www.youtube.com/watch?v=td1_fR43gcg', label: 'Видео 2' },
]

const fileNames: string[] = [
  'Frymaster RE14.pdf',
  'Frymaster RE14 (1).pdf',
  '1.2.1НТ Frymaster настройка температуры .pdf',
]
...
export default function FrymasterRe14Page() {
  return (
    <div>
      <Topbar
        showBreadcrumb
