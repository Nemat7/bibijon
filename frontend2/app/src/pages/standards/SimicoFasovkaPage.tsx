...
const BASE = '/pdfs/oborudovaniye/simeco-fasovka/'

const fileNames: string[] = [
  'Фасовочная станция Simeco.pdf',
  'Фасовочная станция на колесах Simeco.pdf',
  'Фасовочная станция сквозная Simeco.pdf',
  'Fasovochnaya stanciya dlya kartofelya Simeco.pdf',
]
...
export default function SimicoFasovkaPage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
        breadcrumbItems={[
          ...
          { label: 'Фасовочная станция для картофеля Simeco' },
        ]}
      />
      <div className="px-4 pt-5 pb-12 sm:px-8 sm:pt-7">
        ...
        >
          Фасовочная станция для картофеля Simeco
        </h1>
