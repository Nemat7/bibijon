...
const BASE = '/pdfs/oborudovaniye/henny-penny-590/'

const videos = [
  { embed: 'https://www.youtube.com/embed/yrCydxIcs_U', url: 'https://www.youtube.com/watch?v=yrCydxIcs_U', label: 'Видео 1' },
  { embed: 'https://www.youtube.com/embed/NksmOoiS-jM', url: 'https://www.youtube.com/watch?v=NksmOoiS-jM', label: 'Видео 2' },
  { embed: 'https://www.youtube.com/embed/96xbe-Niv-k', url: 'https://www.youtube.com/watch?v=96xbe-Niv-k', label: 'Видео 3' },
  { embed: 'https://www.youtube.com/embed/KTD4U01uKwg', url: 'https://www.youtube.com/watch?v=KTD4U01uKwg', label: 'Видео 4' },
]

const fileNames: string[] = [
  'Henny Penny PFE 590.pdf',
  'Henny Penny PFE-590.pdf',
  'Тайгета 1.1.1 ЧCК Henny Penny 590,592 очистка слайдеров и рабочего клапана_0.pdf',
]
...
export default function HennyPenny590Page() {
  return (
    <div>
      <Topbar
        showBreadcrumb
          ...
          {videos.map((video) => (
            <div key={video.embed}>
              ...
              >
                <iframe
                  src={video.embed}
                  title={`Henny Penny PFE 590 — ${video.label}`}
