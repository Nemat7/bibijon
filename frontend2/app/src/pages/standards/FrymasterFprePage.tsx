...
const BASE = '/pdfs/oborudovaniye/frymaster-fpre214/'

const videos = [
  { embed: 'https://www.youtube.com/embed/yrCydxIcs_U', url: 'https://www.youtube.com/watch?v=yrCydxIcs_U', label: 'Видео 1' },
  { embed: 'https://www.youtube.com/embed/dTbyOV1XcrE', url: 'https://www.youtube.com/watch?v=dTbyOV1XcrE', label: 'Видео 2' },
  { embed: 'https://www.youtube.com/embed/rUaIEgANkmQ', url: 'https://www.youtube.com/watch?v=rUaIEgANkmQ', label: 'Видео 3' },
]

const fileNames: string[] = [
  'Открытый фритюр Frymaster FPRE214.pdf',
  'Фритюр Frymaster FPRE214.pdf',
]
...
export default function FrymasterFprePage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
        breadcrumbItems={[
          ...
          { label: 'Открытый фритюр Frymaster FPRE214' },
        ]}
      />
      <div className="px-4 pt-5 pb-12 sm:px-8 sm:pt-7">
        ...
        >
          Открытый фритюр Frymaster FPRE214
        </h1>
          ...
          {videos.map((video) => (
            <div key={video.embed}>
              ...
              >
                <iframe
                  src={video.embed}
                  title={`Открытый фритюр Frymaster FPRE214 — ${video.label}`}
