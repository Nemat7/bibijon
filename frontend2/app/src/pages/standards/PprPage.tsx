...
const files: DocFile[] = [
  {
    name: 'Планирование кадрового резерва (PPR)',
    href: '/pdfs/razvitiye/ppr/Планирование кадрового резерва (PPR).pdf',
    ext: 'pdf',
  },
  {
    name: 'Шаблон PPR',
    href: '/pdfs/razvitiye/ppr/Шаблон PPR.xlsx',
    ext: 'xlsx',
  },
]
    ...
    <div>
      <Topbar
        ...
        breadcrumbItems={[
          ...
          { label: 'Планирование кадрового резерва (PPR)' },
        ]}
      />
      <div className="px-4 pt-5 pb-12 sm:px-8 sm:pt-7">
        ...
        >
          Планирование кадрового резерва (PPR)
        </h1>
