...
const BASE = '/pdfs/oborudovaniye/simeco-sendvich/'

const fileNames: string[] = [
  'Сэндвичная станция Simeco.pdf',
  'Сэндвичная станция Simeco_0.pdf',
]

function getDisplayName(name: string) {
  return name.replace(/\.[^.]+$/, '').replace(/_0$/, ' (2)')
}

export default function SimicoSendvichPage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
        breadcrumbItems={[
          ...
          { label: 'Сэндвичная станция Simeco' },
        ]}
      />
