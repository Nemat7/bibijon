...
const BASE = '/pdfs/oborudovaniye/true-morozilnik/'

const VIDEO_URL = 'https://www.youtube.com/watch?v=2sp6y1tX86A'
const VIDEO_EMBED = 'https://www.youtube.com/embed/2sp6y1tX86A'

const fileNames: string[] = ['Морозильник TRUE.pdf']

function getDisplayName(name: string) {
  return name.replace(/\.[^.]+$/, '')
}

export default function TrueMorozilnikPage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
