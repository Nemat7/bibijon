...
const BASE = '/pdfs/oborudovaniye/fabristeel-fasovka/'

const fileNames: string[] = [
  'Фасовочная станция для картофеля Fabristeel.pdf',
  'Фасовочная станция Fabristeel.pdf',
  'Станция фасовки FABRISTEEL.pdf',
]
...
export default function FabristeelFasovkaPage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
        breadcrumbItems={[
          ...
          { label: 'Фасовочная станция для картофеля Fabristeel' },
        ]}
      />
      <div className="px-4 pt-5 pb-12 sm:px-8 sm:pt-7">
        ...
        >
          Фасовочная станция для картофеля Fabristeel
        </h1>
