...
const BASE = '/pdfs/oborudovaniye/robolabs-lar/'

const videos = [
  { embed: 'https://www.youtube.com/embed/QcpF735Kg8A', url: 'https://www.youtube.com/watch?v=QcpF735Kg8A', label: 'Видео 1' },
  { embed: 'https://www.youtube.com/embed/e1UHfnv2ntw', url: 'https://www.youtube.com/watch?v=e1UHfnv2ntw', label: 'Видео 2' },
]

const fileNames: string[] = [
  'Ларь морозильный ROBOLABS.pdf',
  'Морозильный ларь ROBOLABS.pdf',
]
...
export default function RobolabsLarPage() {
  return (
    <div>
      <Topbar
        showBreadcrumb
        breadcrumbItems={[
          ...
          { label: 'Ларь морозильный ROBOLABS' },
        ]}
      />
          ...
          {videos.map((video) => (
            <div key={video.embed}>
              ...
              >
                <iframe
                  src={video.embed}
                  title={`Ларь морозильный ROBOLABS — ${video.label}`}
