...
const BASE = '/pdfs/oborudovaniye/hobart/'

const VIDEO_URL = 'https://www.youtube.com/watch?v=yD-XB69yvpg'
const VIDEO_EMBED = 'https://www.youtube.com/embed/yD-XB69yvpg'

const fileNames: string[] = ['Посудомоечная машина Hobart.pdf']
    ...
    <div>
      <Topbar
        ...
        breadcrumbItems={[
          ...
          { label: 'Посудомоечная машина Hobart' },
        ]}
      />
      <div className="px-4 pt-5 pb-12 sm:px-8 sm:pt-7">
        ...
        <div style={{ maxWidth: '780px', marginBottom: '28px' }}>
          ...
          >
            <iframe
              src={VIDEO_EMBED}
              title="Посудомоечная машина Hobart"
