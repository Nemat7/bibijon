...
const BASE = '/pdfs/upravleniye/pravila-bezopasnosti/'

const fileNames: string[] = [
  'Правила безопасности для предупреждения преступлений в помещениях ресторана.pdf',
  'Бланк инвентаризации ключей.pdf',
  'Бланк ознакомления менеджеров с  CSL Правила безопасности для предупреждения преступлений в помещениях ресторана.pdf',
]
    ...
    <div>
      ...
      <div className="px-4 pt-5 pb-12 sm:px-8 sm:pt-7">
        <h1
          ...
          style={{ fontSize: '28px', letterSpacing: '-0.02em', marginBottom: '28px', lineHeight: 1.2 }}
        >
          Правила безопасности для предупреждения преступлений в помещениях ресторана
        </h1>
